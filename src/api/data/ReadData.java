...
public class ReadData {
    ...
    public List<MDartFnlttSinglAcntAll> XmlDartFnlttSinglAcntAll(String corp_code, String bsns_year, String reprt_code,
            String fs_div) {
        List<MDartFnlttSinglAcntAll> list = new ArrayList<>();

        String subDir = "fnlttSinglAcntAll";
        String corpDir = corp_code;
        String filePath = dataFilePath + subDir + "/" + corpDir + "/" + corp_code + "_" + bsns_year + "_" + reprt_code
                + "_" + fs_div
                + ".xml";
    ...
    public List<MDartFnlttSinglAcntAll> XmlDartFnlttSinglAcntAll(String filePath) {
        List<MDartFnlttSinglAcntAll> list = new ArrayList<>();
